...
import com.kangmin.myfirstfile.databinding.ActivitySentenceMainBinding
...
class SentenceMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_sentence_main)
        ...
        binding.showText.setText(randomText)
    }
}
